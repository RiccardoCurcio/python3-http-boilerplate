...
from app.src.application.v1.company.schemas.delete import schema as delete_schema
from app.src.application.v1.company.adapter.delete_company_adapter import DeleteCompanyAdapter
from app.src.infrastructure.v1.company.services.delete_company_service import DeleteCompanyService
...
from app.src.application.v1.company.transformers.delete_company_transformer import DeleteCompanyTranformer
