...
@pytest.fixture()
def mock_update__call(mocker):
    async_mock = AsyncMock()
    mocker.patch(
        "app.src.infrastructure.v1.placeholder.gateways.update_placeholder_gateway.UpdatePaceholderGateway._UpdatePaceholderGateway__call_service",
        side_effect=async_mock,
    )
    async_mock.return_value = {
        "id": "617c4d302bdaae79da0a6778",
...
@pytest.fixture()
def mock_delete__call(mocker):
    async_mock = AsyncMock()
    mocker.patch(
        "app.src.infrastructure.v1.placeholder.gateways.delete_placeholder_gateway.DeletePaceholderGateway._DeletePaceholderGateway__call_service",
        side_effect=async_mock,
    )
    async_mock.return_value = {
        "id": "617c4d302bdaae79da0a6778",
